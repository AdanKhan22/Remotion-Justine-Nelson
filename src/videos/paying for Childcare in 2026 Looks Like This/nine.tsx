...
/**
 * SCENE 9: LOS ANGELES, CALIFORNIA (MARGARET) (150 frames @ 30fps = 5.0s)
 * - Standalone Feature: Part-time care cost reality
 ...
 * - Pin drops, DM Card opens, price rolls from $2,000 -> $1,700
 */
export const Scene9_LosAngelesMargaret: React.FC = () => {
  ...
  // Source of Truth Data: Entry #9
  const location = LOCATIONS.losangeles_margaret;
  ...
  // 6. LIVE PRICE COUNT-DOWN ($2,000 from Host LA -> $1,700 for Margaret)
  const animatedPrice = Math.round(
    interpolate(frame, [92, 116], [2000, 1700], {
      extrapolateLeft: 'clamp',
      extrapolateRight: 'clamp',
...
export default Scene9_LosAngelesMargaret;