...
/**
 * SCENE 8: LOS ANGELES, CALIFORNIA (150 frames @ 30fps = 5.0s)
 * - Standalone Feature: Host's LA preschool transition
 * - Starts at Full US Map (zoom: 1.0)
 * - Highlights California in Ice Blue (#C1E1E6)
 * - Camera eases in with PiP headroom (zoom: 1.75, txFactor: 0.22)
 * - Pin drops, DM Card opens, price rolls from $3,040 -> $2,000
 */
export const Scene8_LosAngelesHost: React.FC = () => {
  ...
  // Source of Truth Data: Entry #8
  const location = LOCATIONS.losangeles_host;
  ...
  // 6. LIVE PRICE COUNT-DOWN ($3,040 from San Diego -> $2,000 for LA)
  const animatedPrice = Math.round(
    interpolate(frame, [92, 116], [3040, 2000], {
      extrapolateLeft: 'clamp',
      extrapolateRight: 'clamp',
...
export default Scene8_LosAngelesHost;