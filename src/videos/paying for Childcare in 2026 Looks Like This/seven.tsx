...
/**
 * SCENE 7: SAN DIEGO, CALIFORNIA (150 frames @ 30fps = 5.0s)
 * - Standalone Feature: Host's personal nanny anecdote
 * - Starts at Full US Map (zoom: 1.0)
 * - Highlights California in Ice Blue (#C1E1E6)
 * - Camera pushes into Southern CA with PiP headroom (zoom: 1.75, txFactor: 0.22)
 * - Pin drops, DM Card opens, price rolls up from $2,700 -> $3,040
 */
export const Scene7_SanDiegoHost: React.FC = () => {
  ...
  // Source of Truth Data: Entry #7
  const location = LOCATIONS.sandiego_host;
  ...
  // Moderated zoom (1.75x) with West Coast shift for PiP space
  ...
  // 6. LIVE PRICE COUNT-UP ($2,700 from Central Valley -> $3,040 for San Diego)
  const animatedPrice = Math.round(
    interpolate(frame, [92, 116], [2700, 3040], {
      extrapolateLeft: 'clamp',
      extrapolateRight: 'clamp',
              ...
              {cardOpacity > 0 && (
                ...
                >
                  ...
                  >
                    ...
                    {/* Row 4: Host Quote in Playfair Display */}
                    <div
                      style={{
                        fontSize: 24 * scale,
                        lineHeight: 1.36,
...
export default Scene7_SanDiegoHost;