...
/**
 * SCENE 11: BAY AREA / SAN FRANCISCO, CALIFORNIA (JOANNA) (150 frames @ 30fps = 5.0s)
 * - Standalone Feature: Daycare minimums & Bay Area nanny rates
 ...
 * - Pin drops, DM Card opens, price rolls up from $2,560 -> $2,600
 */
export const Scene11_BayAreaJoanna: React.FC = () => {
  ...
  // Source of Truth Data: Entry #11
  const location = LOCATIONS.bayarea;
  ...
  // 6. LIVE PRICE COUNT-UP ($2,560 from Lauren -> $2,600 for Joanna)
  const animatedPrice = Math.round(
    interpolate(frame, [92, 116], [2560, 2600], {
      extrapolateLeft: 'clamp',
      extrapolateRight: 'clamp',
...
export default Scene11_BayAreaJoanna;